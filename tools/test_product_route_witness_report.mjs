  ...
  return {
    ...
    producerRoute: {
      ...
      browserKit: {
        ...
        executedModules: [
          { scriptId: '7', executionContextId: 4, url: '/node_modules/.vite/deps/@kaminos_webgpu-inference-kit.js?v=abc', bytes: 1200, sha256: 'c'.repeat(64) },
          { scriptId: '8', executionContextId: 4, url: '/node_modules/.vite/deps/chunk-abc.js', bytes: 800, sha256: 'd'.repeat(64) },
        ],
        producerBinding: {
          executionContextId: 4, kitModuleScriptId: '7', kitModuleUrl: '/node_modules/.vite/deps/@kaminos_webgpu-inference-kit.js?v=abc',
          producerModuleScriptId: '9', producerModuleUrl: '/src/lib/sf3d_producer.js',
          ...
          identityHelperScriptId: '10', identityHelperModuleUrl: '/tools/browser_kit_identity.js',
...
const routeFalsifiers = [
  ...
  ['browser kit dependencies without kit module', validInput({ producerRoute: { ...validInput().producerRoute, browserKit: { ...validInput().producerRoute.browserKit, kitModuleCount: 0, executedModules: [{ scriptId: '8', executionContextId: 4, url: '/node_modules/.vite/deps/chunk-abc.js', bytes: 800, sha256: 'd'.repeat(64) }] } } }), /Chrome-executed producer kit-module binding is missing, ambiguous, or invalid/],
  ['multiple browser kit module instances', validInput({ producerRoute: { ...validInput().producerRoute, browserKit: { ...validInput().producerRoute.browserKit, kitModuleCount: 2, executedModuleCount: 3, executedModules: [...validInput().producerRoute.browserKit.executedModules, { scriptId: '11', executionContextId: 4, url: '/node_modules/.vite/deps/@kaminos_webgpu-inference-kit.js?v=other', bytes: 1200, sha256: 'e'.repeat(64) }] } } }), /Chrome-executed producer kit-module binding is missing, ambiguous, or invalid/],
  ['browser kit context mismatch', validInput({ producerRoute: { ...validInput().producerRoute, browserKit: { ...validInput().producerRoute.browserKit, executedModules: [...validInput().producerRoute.browserKit.executedModules, { scriptId: '11', executionContextId: 5, url: '/node_modules/.vite/deps/chunk-other.js', bytes: 100, sha256: 'e'.repeat(64) }], executedModuleCount: 3 } } }), /module set spans multiple execution contexts/],
  ['producer imports alternate kit module', validInput({ producerRoute: { ...validInput().producerRoute, browserKit: { ...validInput().producerRoute.browserKit, producerBinding: { ...validInput().producerRoute.browserKit.producerBinding, producerImportsKitModuleUrl: '/node_modules/.vite/deps/other-kit.js' } } } }), /Chrome-executed producer kit-module binding is missing, ambiguous, or invalid/],
